...
<style>
    ...
    /* Footer specific CSS - force white text */
    .custom-footer,
    .custom-footer * {
...
# Footer
st.markdown("""
<div class="custom-footer" style="text-align: center; padding: 3rem 2rem; margin-top: 4rem; background: #1e1b4b; border-radius: 2rem 2rem 0 0;">
    <h3 style="margin-bottom: 1rem; font-size: 1.5rem;">🚌 Margshree</h3>
    <p>India's Most Trusted Ride Sharing Platform</p>
